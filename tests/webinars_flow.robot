...
Watch Webinar validations
 ...
 # ===== Case 2: Thursday =====
    IF    '${today}' == 'Thursday'
        Log To Console    Validation if Webinar is on live
     ...
     FOR    ${i}    IN RANGE    3
            ...
            ELSE
                 Swipe By Percent    50    85    50    25    500
                 Wait Until Keyword Succeeds    3s    0.5s    Run Keyword If    '${LIVE}' or '${NO_LIVE}'    No Operation
            END
        END 
        ...
        ELSE
            Fail    Neither banner on live or banner last webinar was found.
        END
    END
